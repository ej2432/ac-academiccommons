// Adds input options based on the student status that is selected.

  $('form#upload select#student').change(function() {
    var isStudent = 'http://rightsstatements.org/vocab/InC/1.0/';
    var notStudent = 'http://rightsstatements.org/vocab/NoC-US/1.0/';
